...
class UnityLauncher(object):
    def __init__(self, port='8080', file_name=None, batch_mode=False, x_display=None, no_graphics=False, logging=False,
        ...
        self.launch_executable(file_name, x_display=x_display, no_graphics=no_graphics, logging=logging,
    ...
    def launch_executable(self, file_name, x_display=None, no_graphics=False, docker_enabled=False, logging=False,
                          args=[]):
        if docker_enabled:
            return
        ...
        if launch_string is None:
            ...
            if not docker_training:
                ...
                subprocess_args += ["-http-port=" + str(self.port_number),
                                    "-logFile {}/Player_{}.log".format(file_path, str(self.port_number))]
